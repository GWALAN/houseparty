/*
  # Fix apply_kit_to_house Color Conversion

  1. Changes
    - Update `apply_kit_to_house` function to convert text[] color_scheme to jsonb
    - Properly handle the conversion from house_kits.color_scheme (text[]) to house_customizations.custom_banner_colors (jsonb)
    
  2. Details
    - The function was passing text[] directly to a jsonb column
    - PostgreSQL needs explicit conversion using to_jsonb()
*/
