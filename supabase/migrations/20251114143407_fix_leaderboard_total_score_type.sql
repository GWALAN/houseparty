/*
  # Fix Leaderboard Function - Total Score Type Casting

  1. Problem
    - SUM(score) returns bigint but function expects numeric
    - Type mismatch causes query to fail

  2. Solution
    - Cast total_score to numeric explicitly
    - Ensures compatibility with function return type
*/
