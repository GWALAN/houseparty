/*
  # Restore check_chance_based_kit_unlock Function

  ## Problem
  The function check_chance_based_kit_unlock is missing from the database,
  causing 404 errors when games are completed.

  ## Solution
  Restore the function with proper permissions.
  
  ## Changes
  1. Creates check_chance_based_kit_unlock function
  2. Grants execute permissions to authenticated users
*/
