/*
  ...
  1. New Tables
    - `friend_requests` - Manages friend request workflow
    - `friendships` - Stores bidirectional friendships
  
  2. Functions
    - `accept_friend_request` - Accepts a friend request and creates friendships
    - `reject_friend_request` - Rejects a friend request
    - `search_users_by_username` - Search for users to add as friends
  
  3. Security
    - Enable RLS on both tables
    - Users can manage their own friend requests and view their friendships
*/
